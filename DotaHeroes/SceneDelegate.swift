...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let barColor = UIColor(named: "textPrimary") ?? UIColor.white
...
extension SceneDelegate {
    func goToHomePage() {
        guard let navigationController = UIStoryboard(name: "HomeViewController", bundle: nil)
            .instantiateInitialViewController() as? UINavigationController,
            let homeView = navigationController.viewControllers.first as? HomeViewController else { return }        
